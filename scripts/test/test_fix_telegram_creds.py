...
class TestPatchWorkflowCredentials:
    ...
    def test_telegram_node_patched(self):
        ...
        result = patch_workflow_credentials(wf, {"id": "99", "name": "Real Telegram"}, {})
    ...
    def test_ssh_node_patched(self):
        ...
        result = patch_workflow_credentials(wf, {"id": "1", "name": "T"}, {"id": "55", "name": "Real SSH"})
        assert result is True
    ...
    def test_ssh_node_skipped_when_no_ssh_cred_id(self):
        ...
        result = patch_workflow_credentials(wf, {"id": "1", "name": "T"}, {})
